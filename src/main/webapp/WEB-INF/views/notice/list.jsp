				...
				<td colspan="4">
					<form action="/notice/search.do" method="get">
						<select name="searchCondition">
							<option value="noticeTitle" <c:if test="${searchCondition == 'noticeTitle' }">selected</c:if>>제목</option>
						</select>
					...
					<td>
					    <button type="button" onclick="showRegisterForm();" style="float: right; margin-right: 100%; font-size: 16px; width: 125%">공지등록</button>
					</td>
				</tr>
			</tfoot>
		</table>
